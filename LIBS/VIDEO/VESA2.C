...
BLITTERS blit_conversions_LFB[6][6] = {
   ...
   { NULL, NULL, NULL, NULL, NULL, NULL },        
   { NULL, NULL, NULL, &Blit15to16_LFB, NULL, NULL },  
   { NULL, NULL, NULL, NULL, NULL, NULL },        
   { NULL, NULL, NULL, NULL, NULL, NULL },        
   { NULL, NULL, NULL, NULL, NULL, NULL }          
};
...
void Blit15to16_LFB(SURFACE *surface)
{
    ...
    width=surface->mode->xsize;

    src=(UWORD *)surface->surface;
    dest=(UWORD *)surface->lfb;
    dest+=surface->y*width + surface->x;

    for(y=0; y<surface->ysize; y++)
        for(x=0; x<surface->xsize; x++)
            *dest++ = *src++;
}
